 ...
 */
public class VerticalQueryMap implements Function<Tuple2<Integer, Trie>, Set<Integer>> {
    private final Broadcast<List<Tuple2<Integer, Query>>> partBroadQueries;
    private final DoubleAccumulator joinTimeAcc;

    public VerticalQueryMap(Broadcast<List<Tuple2<Integer, Query>>> partBroadQueries, DoubleAccumulator joinTimeAcc) {
